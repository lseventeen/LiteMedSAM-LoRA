...
import argparse
from models.efficientvit.sam import efficientvit_sam_l0
# %%
...
# %%
    ...
    def train(self):
        ...
        # else:
        #     train_dataset = NpyBoxDataset(data_root=self.data_root, data_aug=True)
        train_dataset = self.dataset(data_root=self.data_root, image_size = 512, num_each_epoch=100000 ,data_aug=True)
